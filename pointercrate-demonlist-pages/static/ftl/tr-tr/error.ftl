...
error-demonlist-nothirdpartysubmissions = Bu oyuncu sadece kendisinin rekor atabilmesini talep etmiştir.
error-demonlist-submitternotfound = ID'si { $id } olan ibraz eden bulunamadı.
error-demonlist-notenotfound = ID'si { $note-id } olan not ID'si { $record-id } olan rekorda bulunamadı.
...
error-demonlist-submitlegacy = Legacy demonları için rekor gönderemezsiniz
